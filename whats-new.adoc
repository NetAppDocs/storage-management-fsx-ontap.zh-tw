...
在建立工作環境時，您現在可以使用BlueXPlink:https://docs.netapp.com/us-en/storage-management-fsx-ontap/use/task-create-fsx-system.html["產生安全群組"]僅允許所選 VPC 內的流量。此功能link:https://docs.netapp.com/us-en/storage-management-fsx-ontap/requirements/task-setting-up-permissions-fsx.html["需要額外的權限"]。
...
現在您可以選擇啟用link:https://docs.netapp.com/us-en/storage-management-fsx-ontap/use/task-manage-fsx-systems.html["自動容量管理"]根據需求新增增量儲存。自動容量管理定期輪詢叢集以評估需求，並自動以 10% 的增量增加儲存容量，直到達到叢集最大容量的 80%。
...
您現在可以link:https://docs.netapp.com/us-en/storage-management-fsx-ontap/use/task-manage-fsx-systems.html["變更儲存容量和 IOPS"]在建立 FSx for ONTAP工作環境後隨時。
...
link:https://docs.netapp.com/us-en/storage-management-fsx-ontap/use/task-create-fsx-system.html#discover-an-existing-fsx-for-ontap-file-system["使用「我的資產」探索 FSx for ONTAP"]



=== 更改吞吐能力

您現在可以link:https://docs.netapp.com/us-en/storage-management-fsx-ontap/use/task-manage-fsx-systems.html["改變吞吐能力"]在建立 FSx for ONTAP工作環境後隨時。
...
link:https://docs.netapp.com/us-en/storage-management-fsx-ontap/use/task-create-fsx-system.html["建立 FSx for ONTAP工作環境"]
...
link:https://docs.netapp.com/us-en/storage-management-fsx-ontap/requirements/task-setting-up-permissions-fsx.html#set-up-the-iam-role["設定 IAM 角色"]
...
link:https://docs.netapp.com/us-en/storage-management-fsx-ontap/requirements/task-setting-up-permissions-fsx.html["了解如何設定 FSx for ONTAP 的權限"]。
...
+
link:https://docs.netapp.com/us-en/storage-management-fsx-ontap/start/concept-fsx-aws.html["了解適用Amazon FSx for NetApp ONTAP"]。

* 您可以在 Cloud Manager 中設定 FSx for ONTAP工作環境。
+
link:https://docs.netapp.com/us-en/storage-management-fsx-ontap/use/task-create-fsx-system.html["建立Amazon FSx for NetApp ONTAP工作環境"]。

* 使用 AWS 和 Cloud Manager 中的連接器，您可以建立和管理磁碟區、複製資料以及將 FSx for ONTAP與NetApp雲端服務（例如 Data Sense 和Cloud Sync）整合。
+
link:https://docs.netapp.com/us-en/data-services-data-classification/task-scanning-fsx.html["開始使用適用於Amazon FSx for NetApp ONTAP 的Cloud Data Sense"^]。
