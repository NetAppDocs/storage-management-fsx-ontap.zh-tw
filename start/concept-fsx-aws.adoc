...
link:../use/task-create-fsx-system.html["了解如何從NetApp Console建立和發現 FSx for ONTAP系統"]。
...
對於特定於NetApp Console或NetApp儲存解決方案和服務的一般和技術支援問題，您可以使用NetApp組織級序號開啟NetApp支援票證。你需要link:https://docs.netapp.com/us-en/storage-management-fsx-ontap/support/task-support-registration.html["註冊您的NetApp組織"^]啟動支援。
